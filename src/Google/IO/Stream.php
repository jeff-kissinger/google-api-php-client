...
class Stream extends \Google\IO\Abstract
{
   ...
   *
   * @param \Google\HttpRequest $request the http request to be executed
   * @return \Google\HttpRequest http request with the response http code,
   * response headers and response body filled in
   * @throws \Google\IO\IOException on curl or IO error
   */
  public function makeRequest(\Google\Http\Request $request)
  {
    ...
    if (false === $response_data) {
      throw new \Google\IO\IOException("HTTP Error: Unable to connect");
    }
