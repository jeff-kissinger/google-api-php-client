<?php
namespace Google\Service\Directory\Mobiledevices;
...
class Resource extends \Google\Service\Resource
{
   ...
   * @param \Google\MobileDeviceAction $postBody
   * @param array $optParams Optional parameters.
   */
  public function action($customerId, $resourceId, \Google\Service\Directory\MobileDeviceAction $postBody, $optParams = array())
  {
   ...
   * @return \Google\Service\Directory\MobileDevice
   */
  public function get($customerId, $resourceId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'resourceId' => $resourceId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\Google\Service\Directory\MobileDevice");
  }
  /**
   ...
   * @return \Google\Service\Directory\MobileDevices
   */
  public function listMobiledevices($customerId, $optParams = array())
  {
    $params = array('customerId' => $customerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\Google\Service\Directory\MobileDevices");
  }
}
