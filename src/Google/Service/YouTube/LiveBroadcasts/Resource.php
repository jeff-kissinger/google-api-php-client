<?php
namespace Google\Service\YouTube\LiveBroadcasts;
...
class Resource extends \Google\Service\Resource
{
   ...
   * @return \Google\Service\YouTube\LiveBroadcast
   */
  public function bind($id, $part, $optParams = array())
  {
    $params = array('id' => $id, 'part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('bind', array($params), "\Google\Service\YouTube\LiveBroadcast");
  }
  /**
  ...
  public function control($id, $part, $optParams = array())
  {
    $params = array('id' => $id, 'part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('control', array($params), "\Google\Service\YouTube\LiveBroadcast");
  }
  /**
  ...
  The part
    ...
    * status.
   * @param \Google\LiveBroadcast $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string onBehalfOfContentOwner
   * Note: This parameter is intended exclusively for YouTube content partners.
   ...
   * @return \Google\Service\YouTube\LiveBroadcast
   */
  public function insert($part, \Google\Service\YouTube\LiveBroadcast $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\Google\Service\YouTube\LiveBroadcast");
  }
  /**
   ...
   * The id parameter specifies a comma-separated list of YouTube broadcast IDs that identify the
    ...
    * broadcast's ID.
   * @return \Google\Service\YouTube\LiveBroadcastListResponse
   */
  public function listLiveBroadcasts($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\Google\Service\YouTube\LiveBroadcastListResponse");
  }
  /**
  ...
  public function transition($broadcastStatus, $id, $part, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('transition', array($params), "\Google\Service\YouTube\LiveBroadcast");
  }
  /**
   ...
   * @return \Google\Service\YouTube\LiveBroadcast
   */
  public function update($part, \Google\Service\YouTube\LiveBroadcast $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "\Google\Service\YouTube\LiveBroadcast");
  }
}
