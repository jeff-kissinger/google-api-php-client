<?php
namespace Google\Service\YouTube\Activities;
...
class Resource extends \Google\Service\Resource
{
   ...
   * @return \Google\Service\YouTube\Activity
   */
  public function insert($part, \Google\Service\YouTube\Activity $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\Google\Service\YouTube\Activity");
  }
  /**
   ...
   * @return \Google\Service\YouTube\ActivityListResponse
   */
  public function listActivities($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\Google\Service\YouTube\ActivityListResponse");
  }
}
