<?php
namespace Google\Service\YouTube\Subscriptions;
...
class Resource extends \Google\Service\Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return \Google\Service\YouTube\Subscription
   */
  public function insert($part, \Google\Service\YouTube\Subscription $postBody, $optParams = array())
  {
    $params = array('part' => $part, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\Google\Service\YouTube\Subscription");
  }
  /**
   ...
   * @return \Google\Service\YouTube\SubscriptionListResponse
   */
  public function listSubscriptions($part, $optParams = array())
  {
    $params = array('part' => $part);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\Google\Service\YouTube\SubscriptionListResponse");
  }
}
