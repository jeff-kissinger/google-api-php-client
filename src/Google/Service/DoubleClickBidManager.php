...
class DoubleClickBidManager extends \Google\Service
{
  ...
  public function __construct(\Google\Client $client)
  {
    ...
    $this->lineitems = new \Google\Service\DoubleClickBidManager\Lineitems\Resource(
        $this,
        $this->serviceName,
        'lineitems',
        array(
    ...
    $this->queries = new \Google\Service\DoubleClickBidManager\Queries\Resource(
        $this,
        $this->serviceName,
        'queries',
        array(
    ...
    $this->reports = new \Google\Service\DoubleClickBidManager\Reports\Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
