<?php
namespace Google\Service\Blogger\Blogs;
...
class Resource extends \Google\Service\Resource
{
   ...
   * @return \Google\Service\Blogger\Blog
   */
  public function get($blogId, $optParams = array())
  {
    $params = array('blogId' => $blogId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\Google\Service\Blogger\Blog");
  }
  /**
  ...
  public function getByUrl($url, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('getByUrl', array($params), "\Google\Service\Blogger\Blog");
  }
  /**
   ...
   * @opt_param string view
   * Access level with which to view the blogs. Note that some fields require elevated access.
   * @return \Google\Service\Blogger\BlogList
   */
  public function listByUser($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('listByUser', array($params), "\Google\Service\Blogger\BlogList");
  }
}
