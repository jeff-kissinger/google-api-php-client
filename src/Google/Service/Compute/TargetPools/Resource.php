<?php
namespace Google\Service\Compute\TargetPools;
...
class Resource extends \Google\Service\Resource
{
   ...
   * @param \Google\TargetPoolsAddHealthCheckRequest $postBody
   ...
   * @param \Google\TargetPoolsAddInstanceRequest $postBody
   * @param array $optParams Optional parameters.
   * @return \Google\Service\Compute\Operation
   */
   ...
   * @param \Google\InstanceReference $postBody
   * @param array $optParams Optional parameters.
   ...
   * @param string $region
   * Name of the region scoping this request.
   * @param \Google\TargetPool $postBody
   * @param array $optParams Optional parameters.
   * @return \Google\Service\Compute\Operation
   */
   ...
   * @param \Google\TargetPoolsRemoveHealthCheckRequest $postBody
   * @param array $optParams Optional parameters.
   * @return \Google\Service\Compute\Operation
   */
   ...
   * @param \Google\TargetPoolsRemoveInstanceRequest $postBody
   * @param array $optParams Optional parameters.
   * @return \Google\Service\Compute\Operation
   */
