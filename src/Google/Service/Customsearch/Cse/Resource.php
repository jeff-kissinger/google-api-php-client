<?php
namespace Google\Service\Customsearch\Cse;
...
class Resource extends \Google\Service\Resource
{
   ...
   * Controls whether to include or exclude results from the site named in the as_sitesearch
    * parameter
   * @return \Google\Service\Customsearch\Search
   */
  public function listCse($q, $optParams = array())
  {
    $params = array('q' => $q);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\Google\Service\Customsearch\Search");
  }
}
