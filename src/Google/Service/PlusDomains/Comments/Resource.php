<?php
namespace Google\Service\PlusDomains\Comments;
...
class Resource extends \Google\Service\Resource
{
   ...
   * @return \Google\Service\PlusDomains\Comment
   */
  public function get($commentId, $optParams = array())
  {
    $params = array('commentId' => $commentId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "\Google\Service\PlusDomains\Comment");
  }
  /**
   ...
   * @return \Google\Service\PlusDomains\Comment
   */
  public function insert($activityId, \Google\Service\PlusDomains\Comment $postBody, $optParams = array())
  {
    $params = array('activityId' => $activityId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "\Google\Service\PlusDomains\Comment");
  }
  /**
   ...
   * @return \Google\Service\PlusDomains\CommentFeed
   */
  public function listComments($activityId, $optParams = array())
  {
    $params = array('activityId' => $activityId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\Google\Service\PlusDomains\CommentFeed");
  }
}
