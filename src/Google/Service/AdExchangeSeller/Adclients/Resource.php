<?php
namespace Google\Service\AdExchangeSeller\Adclients;
...
class Resource extends \Google\Service\Resource
{
   ...
   * @return \Google\Service\AdExchangeSeller\AdClients
   */
  public function listAdclients($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "\Google\Service\AdExchangeSeller\AdClients");
  }
}
